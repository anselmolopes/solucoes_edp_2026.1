...
\solucao{
	...
	$$- \int_U w_{11} \phi dx = - \int_{B_1(0)} \frac{x_1^2 - |x|^2}{|x|^3} \cdot 1 \, dx - \int_{B_2 \setminus B_1} 0 \cdot \phi dx.$$
	...
	\begin{align*}
		...
		&= \int_0^1 r^{n-2} \left( \int_{\partial B_1(0)} (\xi_1^2 - 1) d\sigma_\xi \right) dr = \left( \int_0^1 r^{n-2} dr \right) \left( \frac{1}{n}\omega_n - \omega_n \right) \\
		&= \frac{1}{n-1} \omega_n \left( \frac{1-n}{n} \right) = -\frac{\omega_n}{n} \neq 0
	\end{align*}
