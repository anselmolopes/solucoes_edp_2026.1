...
\begin{theorem*}[\textbf{Teorema da Coincidência}]
	Seja $U \subset \mathbb{R}^n$ um aberto e $u \in W^{1,p}(U)$. Então, a derivada fraca $\tfrac{\partial u}{\partial x_j}$ \textit{coincide} quase sempre com a derivada clássica $\tfrac{\partial u}{\partial x_j}$ em todo ponto $x \in U$ onde esta última existe.
\end{theorem*}
