...
\pagestyle{empty}
\newcommand{\linhaestilizada}{ % Linha centralizada verticalmente no diamante
	\par\noindent\makebox[\textwidth]{\rule[0.5ex]{0.4\textwidth}{0.4pt}\hfill$\diamond$\hfill\rule[0.5ex]{0.43\textwidth}{0.4pt}\par}
}
...
\newcommand{\sintese}[1]{%
	\ifbool{showsintese}{%
		\par\textbf{\underline{Síntese da Construção}}:\par 
		#1\par
	}{}%
}
