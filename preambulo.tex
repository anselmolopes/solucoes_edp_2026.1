...
\newbool{showaprofundamento} % Corrigido o erro de digitação aqui
...
% Define o ambiente theorem* como não numerado (Nome original restaurado)
\theoremstyle{definition} 
\newtheorem*{theorem*}{Teorema} 

% Customização ROBUSTA do ambiente de prova (Proof)
\makeatletter
...
\addto\captionsbrazilian{\renewcommand{\proofname}{Demonstração}}
