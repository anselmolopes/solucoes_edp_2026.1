...
% --- Configuração para Resultados Extras (Aprofundamento) ---

\newbool{showaprofundamento} 
\setbool{showaprofundamento}{true} % Altere para 'false' para ocultar

% Comando para a linha estilizada
\newcommand{\linhaestilizada}{%
	\begin{center}
		\rule{0.3\textwidth}{0.4pt} $\diamond$ \rule{0.3\textwidth}{0.4pt}
	\end{center}
}

% Definição do comando \resultadoextra
