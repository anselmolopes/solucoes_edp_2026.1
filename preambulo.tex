...
\newcommand{\linhaestilizada}{ % Comando para a linha estilizada
	\begin{center}
		\rule{0.3\textwidth}{0.4pt} $\diamond$ \rule{0.3\textwidth}{0.4pt}
	\end{center}
}
...
\setbool{showaprofundamento}{true} % Controla a exibição da \aprofundamento

% =============================================================================
% COMANDOS ESTRUTURAIS DO PROJETO
% =============================================================================

% VALOR PADRÃO PARA EVITAR ERROS NA COMPILAÇÃO INDIVIDUAL DO SUBFILE
...
% 6. Aprofundamento: O ambiente para discussões mais aprofundadas e generalizações
\newcommand{\aprofundamento}[1]{%
	\ifbool{showaprofundamento}{%
		\linhaestilizada
		\nopagebreak % Tenta evitar quebra de página logo após a linha
		\subsection*{\underline{Aprofundamento Teórico}}
		#1
		\par\vspace{0.5em}
		\linhaestilizada
	}{}%
