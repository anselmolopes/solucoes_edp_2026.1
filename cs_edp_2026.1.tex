...
\nocite{*}
	...
	\begin{tcolorbox}[
		...
		\begin{itemize}
			...
			\item \texttt{\textbackslash setbool\{showtheorem\}\{false\}} $\longrightarrow$ Oculta o \textbf{Teorema Auxiliar}.
			\item \texttt{\textbackslash setbool\{showproof\}\{false\}} $\longrightarrow$ Oculta a \textbf{Demonstração (prova) do Teorema}.
		\end{itemize}
